      ...
      openActions: [
        {
          id: "ACT-DEMO-1",
          priority: "High",
          affectedRecord: "Gary Bullard",
          recordType: "Direct agent",
          action: "Confirm all carrier onboarding steps are complete.",
          owner: "Shawn",
          dueDate: "2026-07-24",
          status: "Open",
          blocker: "",
          ...
          externalSource: "SAB",
          externalRecordId: "demo-agent-1",
          requirementKey: "carrier-onboarding",
          uploadUrl: "https://example.com/synthetic-upload",
          sourceStatus: "Missing",
          sourceCheckedAt: "2026-07-24 09:15 CDT",
          syncLifecycle: "Managed",
          mirrorEvidence: [],
          mirrorSummary: "",
          mirrorSyncedAt: "2026-07-24 09:15 CDT",
          requiresManualConfirmation: false,
        },
        {
          id: "ACT-DEMO-2",
          priority: "Normal",
          affectedRecord: "TriBe",
          recordType: "TriBe",
          action: "Confirm the next SAB implementation check-in.",
          owner: "Shawn",
          dueDate: "2026-07-27",
          status: "Open",
          blocker: "",
